...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-4xl text-3xl font-medium title-font mb-4 text-gray-900"> About Ringa, and Cloud Galaxy.</h1>

      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">The expectation is that this video will be unique and exciting, bringing together fans from all sides. This is a significant step for the artist, Cloud Galaxy in his music career and journey, and it signifies the great success that is to come. Kwenye mwezi wa Oktoba, msanii atashusha video mpya ya muziki. Msanii huyu amejitambulisha kwa jina jipya- "Cloud Galaxy", na atashirikisha muziki wa kipekee ambao utavutia mashabiki.</p>


      
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base bold italic">
